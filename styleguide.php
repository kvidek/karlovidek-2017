    ...
    <section class="section styleguide__section section--logo">
        <div class="container styleguide__container">
            <svg class="icon icon-badel">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-galbani');?>">
                </use>
            </svg>
        </div>
    </section>
    ...
    <section class="section styleguide__section section--buttons">
        ...
        <div class="container styleguide__container">
            <svg class="icon icon-arrow-left">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-arrow-left');?>">
                </use>
            </svg>
            <svg class="icon icon-arrow-right">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-arrow-right');?>">
                </use>
            </svg>
            <svg class="icon icon-arrow-down">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-arrow-down');?>">
                </use>
            </svg>
            <svg class="icon icon-arrow-up">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-arrow-up');?>">
                </use>
            </svg>
            <svg class="icon icon-angle-left">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-angle-left');?>">
                </use>
            </svg>
            <svg class="icon icon-angle-right">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-angle-right');?>">
                </use>
            </svg>
            <svg class="icon icon-facebook">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-facebook');?>">
                </use>
            </svg>
            <svg class="icon icon-instagram">
                <use xlink:href="<?=bu('static/ui/svg/symbol-defs.svg#icon-instagram');?>">
                </use>
            </svg>
        </div>
    </section>
